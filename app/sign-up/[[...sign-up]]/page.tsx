      ...
      <SignUp.Root>
        <SignUp.Step name="start" className="w-full space-y-6 rounded-2xl px-4 py-10 sm:w-96 sm:px-8">
          <header className="text-center">
            ...
            <h1 className="mt-4 text-xl font-medium tracking-tight text-neutral-950">Sign up to PDF Chat</h1>
          </header>
          ...
          <div className="rounded-xl bg-neutral-100 p-5">
            <p className="mb-4 text-center text-sm/5 text-neutral-500">Alternatively, sign up with these platforms</p>
        ...
        <SignUp.Step name="verifications" className="w-full space-y-6 rounded-2xl px-4 py-10 sm:w-96 sm:px-8">
